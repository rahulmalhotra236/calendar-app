      ...
      <div className="calendar">
        ...
        <div className="days">
          ...
          {[
            ...Array(daysInMonth)
              .keys()]
            .map((day) => <span key={`empty-{index}`} className={day + 1 === currentDate.getDate() && currentMonth === currentDate.getMonth() && currentYear === currentDate.getFullYear() ? "current-day" : ""} >{day+1}</span>)
          }
        </div>
      </div>
